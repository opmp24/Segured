        ...
        <div className="container py-5 position-relative">
          ...
          >
            ...
            <p className="lead text-white-50 col-lg-8 mx-auto">
              Ofrecemos un abanico completo de servicios orientados a la prevenci&oacute;n de
              riesgos laborales.
            </p>
          </motion.div>
        </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 ps-lg-5">
              ...
              <p className="text-muted mb-4">
                Nuestro giro principal es la prevenci&oacute;n de riesgos laborales. Brindamos
                asesor&iacute;a experta, realizamos visitas t&eacute;cnicas y capacitamos a su
                personal para fomentar una cultura de seguridad. Implementamos sistemas de
                gesti&oacute;n robustos, como el DS 44, para garantizar el cumplimiento normativo.
              </p>
              <p className="text-muted">
                Adem&aacute;s, complementamos nuestra oferta con servicios pr&aacute;cticos que
                incluyen la venta de Elementos de Protecci&oacute;n Personal (EPP) y equipos de
                extinci&oacute;n, junto con la ejecuci&oacute;n de obras menores,
                construcci&oacute;n, paisajismo y mantenimiento de &aacute;reas verdes.
              </p>
            </div>
          </div>
        </motion.section>
        ...
        <motion.section {...fadeUp} className="py-5">
          ...
          <div className="row g-4 justify-content-center">
            {[
              {
                title: 'Compromiso',
                text: 'Nos implicamos a fondo en cada proyecto, entendiendo las necesidades espec\u00edficas de nuestros clientes para ofrecer soluciones a medida.',
              },
              {
                title: 'Excelencia',
                text: 'Buscamos la m\u00e1xima calidad en nuestros servicios, manteni\u00e9ndonos actualizados con las \u00faltimas normativas y tecnolog\u00edas del sector.',
              },
              {
                title: 'Innovaci\u00f3n',
                text: 'Aplicamos m\u00e9todos y herramientas innovadoras para la gesti\u00f3n de riesgos, asegurando auditor\u00edas precisas y formaci\u00f3n efectiva.',
              },
            ].map((v, i) => (
              <motion.div
                key={v.title}
              ...
              >
                <div className="feature-box text-center">
                  <div className="feature-icon mb-3">
                    <i
                      className={`bi ${i === 0 ? 'bi-shield-check' : i === 1 ? 'bi-star' : 'bi-lightbulb'} display-4`}
                    ></i>
                  </div>
                  <h4>{v.title}</h4>
